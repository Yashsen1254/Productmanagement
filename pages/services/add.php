                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <form class="space-y-4">
                                    <input id="BuyerName" type="text" name="BuyerName" class="form-input" placeholder="BuyerName">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Buyer Number</h2>
                                <form class="space-y-4">
                                    <input id="BuyerNumber" type="number" name="BuyerNumber" class="form-input" placeholder="BuyerNumber">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Buyer Address</h2>
                                <form class="space-y-4">
                                    <input id="BuyerAddress" type="text" name="BuyerAddress" class="form-input" placeholder="BuyerAddress">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Buyer City</h2>
                                <form class="space-y-4">
                                    <input id="BuyerCity" type="text" name="BuyerCity" class="form-input" placeholder="BuyerCity">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Buyer State</h2>
                                <form class="space-y-4">
                                    <input id="BuyerState" type="text" name="BuyerState" class="form-input" placeholder="BuyerState">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">To Date</h2>
                                <form class="space-y-4">
                                    <input id="ToDate" type="date" name="ToDate" class="form-input" placeholder="ToDate">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">From Date</h2>
                                <form class="space-y-4">
                                    <input id="FromDate" type="date" name="FromDate" class="form-input" placeholder="FromDate">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Price</h2>
                                <form class="space-y-4">
                                    <input id="Price" type="number" name="Price" class="form-input" placeholder="Price">
                                </form>
                            </div>
                        </div>
