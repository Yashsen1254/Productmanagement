                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <form class="space-y-4">
                                    <input id="Name" type="text" class="form-input" placeholder="Name" name="Name" autofocus>
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Email</h2>
                                <form class="space-y-4">
                                    <input id="Email" type="email" class="form-input" placeholder="Email" name="Email">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Password</h2>
                                <form class="space-y-4">
                                    <input id="Password" class="form-input" placeholder="Password" name="Password" type="password">
                                </form>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
