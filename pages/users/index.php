                    ...
                    <div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Users Table</h2>
                                            ...
                                            <?php if ($permissions['ViewPermission'] == 1) {
                                                ...
                                                foreach ($users as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($permissions['DeletePermission'] == 1) { ?>
                                                        <td>
                                                            <button type="button" class="btn btn-danger btn-circle mb-2" onclick="deleteUsers(<?= $user['UserId'] ?>)">Delete</button>
                                                        </td>
                                                        <?php }?>
                                                    </tr>
                                                <?php endforeach;
...
<script>
        function deleteUsers(UserId) {
            if (confirm("sure you want to delete this users"));
            $.ajax({
